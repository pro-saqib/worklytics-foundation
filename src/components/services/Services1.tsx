        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-primary-foreground rounded-lg p-10 pb-14 flex-start flex-col bg-[radial-gradient(at_top_right,_#101e8a_0%,_#010630_77%)]">
            ...
            <p className="text-sm opacity-80 mb-8 flex-grow">
              Want to learn how our expertise can elevate your business? Click on this link below to view all our expertise.
            </p>
            <Button
              asChild
            ...
            >
              <Link to="/services">All Services<MoveUpRight className="w-6 h-6 fill-white" /></Link>
            </Button>
          </div>
        </div>
      </div>
